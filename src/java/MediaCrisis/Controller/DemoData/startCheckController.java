 ...
 * @author letru
 */
@WebServlet(name = "startCheckController", urlPatterns = {"/startCheckController"})
public class startCheckController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String url = "http://localhost:8181/checkMeaning/check";
