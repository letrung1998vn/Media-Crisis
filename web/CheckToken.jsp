<%-- 
    Document   : CheckToken
    Created on : Mar 26, 2020, 8:06:02 PM
    Author     : letru
--%>
...
<html>
    ...
    <body>
        <form action="MainController" method="post" id="form-update-token">
            <input id="tokenString" type="hidden" name="txtToken">
            <input type="hidden" name="btnAction" value="CheckNotificationToken">
        </form>
