 ...
 */
@WebServlet(name = "GetNewCrawlPostController", urlPatterns = {"/GetNewCrawlPostController"})
public class GetNewCrawlPostController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String urlGetNewPost = "http://localhost:8181/post/getNewPost";
