 ...
 * @author letru
 */
@WebServlet(name = "WebLinkContentListPost", urlPatterns = {"/WebLinkContentListPost"})
public class WebLinkContentListPost extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                String postKeyword = jsonResult.getString("keyword");
                ...
                request.setAttribute("keyword", postKeyword);
