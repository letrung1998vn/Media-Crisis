 ...
 */
@WebServlet(name = "ImportScriptFileCase3Controller", urlPatterns = {"/ImportScriptFileCase3Controller"})
public class ImportScriptFileCase3Controller extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ImportScriptFileCase3Controller.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
