                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="validate-input col-md-12" data-validate = "">
                                                            ...
                                                            <div class="col-md-2">
                                                                <button class="btn btn-add-new-keyword btn-primary" style="width: 150px" type="submit" value="CreateKeywordAdmin" name="btnAction">
                                                                    Add
                                                                </button>
                                                            </div>
                                                        </div>
                                            ...
                                            <table id="myTable" class="table table-hover table-striped">
                                                ...
                                                <form class="login100-form validate-form-update-keyword" action="MainController" method="POST">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button id="btn-update-keyword-<%= i%>" class="btn btn-success hidden" type="submit" value="UpdateKeywordAdmin" name="btnAction" onclick="return confirm('Are you sure you want to update this item?');">
                                                            Update
                                                        </button>
                                                    </td>
                                                </form>
