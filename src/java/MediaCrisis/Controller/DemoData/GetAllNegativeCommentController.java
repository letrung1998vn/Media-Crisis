 ...
 */
@WebServlet(name = "GetAllNegativeCommentController", urlPatterns = {"/GetAllNegativeCommentController"})
public class GetAllNegativeCommentController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String urlGetNewPost = "http://localhost:8181/comment/getNegativeComment";
